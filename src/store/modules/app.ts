  ...
  state: (): AppState => {
    return {
      ...
      theme: wsCache.get(CACHE_KEY.THEME) || {
        // 主题色
        elColorPrimary: '#a85f4b',
        // 左侧菜单边框颜色
        leftMenuBorderColor: 'inherit',
        // 左侧菜单背景颜色
        leftMenuBgColor: '#171518',
        // 左侧菜单浅色背景颜色
        leftMenuBgLightColor: '#201d21',
        // 左侧菜单选中背景颜色
        leftMenuBgActiveColor: 'rgb(255 255 255 / 12%)',
        // 左侧菜单收起选中背景颜色
        leftMenuCollapseBgActiveColor: 'rgb(255 255 255 / 12%)',
        // 左侧菜单字体颜色
        leftMenuTextColor: 'rgb(255 255 255 / 70%)',
        // 左侧菜单选中字体颜色
        ...
        // 头部字体颜色
        topHeaderTextColor: '#242124',
        // 头部悬停颜色
        topHeaderHoverColor: '#f8f5f3',
        // 头部边框颜色
