...
const LoginFormCacheMigrationKey = 'loginFormDefaultCleared'

export const clearLegacyLoginFormCache = () => {
  if (wsCache.get(LoginFormCacheMigrationKey)) {
    return
  }
  removeLoginForm()
  wsCache.set(LoginFormCacheMigrationKey, true)
}
