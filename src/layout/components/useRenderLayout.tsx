...
import { ClientCard } from '@/layout/components/ClientCard'
  ...
  const renderClassic = () => {
    return (
      <>
        <div
          class={[
            'flex flex-col absolute top-0 left-0 h-full layout-border__right bg-[var(--left-menu-bg-color)]',
        ...
        >
          ...
          {!collapse.value ? <ClientCard></ClientCard> : undefined}
          <Menu class="flex-1 min-h-0"></Menu>
        </div>
        <div
          class={[
            `${prefixCls}-content`,
